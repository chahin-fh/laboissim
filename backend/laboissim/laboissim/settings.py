...
WSGI_APPLICATION = 'laboissim.laboissim.wsgi.application'
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'laboissim.laboissim.social_pipeline.prevent_duplicate_email',  # Custom step to prevent duplicate emails
    'social_core.pipeline.social_auth.auth_allowed',
    'social_core.pipeline.social_auth.social_user',
    'social_core.pipeline.user.get_username',
    'social_core.pipeline.user.create_user',
    'laboissim.laboissim.social_pipeline.save_profile',  # Custom step to save extra info
