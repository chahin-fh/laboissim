                    ...
                    <div>
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <Button
                          ...
                          title={selectedUploadFileName ? selectedUploadFileName : "Ajouter"}
                        >
                          <Upload className="h-4 w-4 mr-1" />
                          {selectedUploadFileName
                            ? `${selectedUploadFileName}${isUploadingDocument ? " (téléversement...)" : ""}`
                            : "Ajouter"}
                        </Button>
                      </div>
                          ...
                          <div className="flex items-center gap-3">
                            <Input
                              ...
                              onChange={(e) => {
                                ...
                                if (file) {
                                  ...
                                  // Start upload immediately but keep the section open to show file name
                            ...
                            {selectedUploadFileName && (
                              <span className="text-sm text-gray-700 whitespace-nowrap">
                                Fichier: {selectedUploadFileName}
                                {isUploadingDocument ? " (téléversement...)" : ""}
                              </span>
                            )}
                          </div>
                        </motion.div>
